...
@section('title', 'Tambah Jenis Pinjaman - Simple Akunting')

@section('content')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Tambah Jenis Pinjaman</h1>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('kode_pinjaman') is-invalid @enderror" 
                                id="kode_pinjaman" name="kode_pinjaman" value="{{ old('kode_pinjaman') }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_pinjaman') is-invalid @enderror" 
                                id="nama_pinjaman" name="nama_pinjaman" value="{{ old('nama_pinjaman') }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('kategori') is-invalid @enderror" id="kategori" name="kategori" required>
                                ...
                                <option value="konsumtif" {{ old('kategori') == 'konsumtif' ? 'selected' : '' }}>Konsumtif</option>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('bunga_pertahun') is-invalid @enderror" 
                                id="bunga_pertahun" name="bunga_pertahun" value="{{ old('bunga_pertahun', 12) }}" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('metode_bunga') is-invalid @enderror" id="metode_bunga" name="metode_bunga" required>
                                <option value="flat" {{ old('metode_bunga') == 'flat' ? 'selected' : '' }}>Flat</option>
                                <option value="anuitas" {{ old('metode_bunga') == 'anuitas' ? 'selected' : '' }}>Anuitas</option>
                                <option value="efektif" {{ old('metode_bunga') == 'efektif' ? 'selected' : '' }}>Efektif</option>
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('tenor_max') is-invalid @enderror" 
                                id="tenor_max" name="tenor_max" value="{{ old('tenor_max', 12) }}" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('plafon_max') is-invalid @enderror" 
                                id="plafon_max" name="plafon_max" value="{{ old('plafon_max', 10000000) }}" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('provisi_persen') is-invalid @enderror" 
                                id="provisi_persen" name="provisi_persen" value="{{ old('provisi_persen', 1) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('akun_piutang_pinjaman') is-invalid @enderror" 
                                ...
                                @foreach($akunPiutang as $akun)
                                    <option value="{{ $akun->kode_akun }}" {{ old('akun_piutang_pinjaman') == $akun->kode_akun ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('akun_pendapatan_bunga') is-invalid @enderror" 
                                ...
                                @foreach($akunPendapatan as $akun)
                                    <option value="{{ $akun->kode_akun }}" {{ old('akun_pendapatan_bunga') == $akun->kode_akun ? 'selected' : '' }}>
                                        {{ $akun->kode_akun }} - {{ $akun->nama_akun }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('akun_pendapatan_provisi') is-invalid @enderror" 
                                ...
                                @foreach($akunPendapatan as $akun)
                                    <option value="{{ $akun->kode_akun }}" {{ old('akun_pendapatan_provisi') == $akun->kode_akun ? 'selected' : '' }}>
                                        {{ $akun->kode_akun }} - {{ $akun->nama_akun }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('akun_pendapatan_admin') is-invalid @enderror" 
                                ...
                                <option value="">-- Pilih Akun (Opsional) --</option>
                                @foreach($akunPendapatan as $akun)
                                    <option value="{{ $akun->kode_akun }}" {{ old('akun_pendapatan_admin') == $akun->kode_akun ? 'selected' : '' }}>
                                        {{ $akun->kode_akun }} - {{ $akun->nama_akun }}
                                    </option>
                                @endforeach
                            </select>
