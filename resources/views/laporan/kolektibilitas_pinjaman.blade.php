...
<div class="card mb-4">
    <div class="card-body">
        <form action="{{ route('laporan.kolektibilitas_pinjaman') }}" method="GET" class="row g-3 align-items-end">
            <div class="col-md-3">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                <a href="{{ route('laporan.kolektibilitas_pinjaman') }}" class="btn btn-secondary">Reset</a>
            </div>
        </form>
    </div>
</div>
