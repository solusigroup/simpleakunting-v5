...
@section('title', 'Arus Kas (Metode Tidak Langsung) - Simple Akunting')

@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Laporan Arus Kas (Metode Tidak Langsung)</h1>
    </div>

    <!-- Filter -->
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('laporan.aruskas_tidak_langsung') }}" method="GET" class="row g-3 align-items-end">
                <div class="col-md-3">
                ...
                <div class="col-md-12 d-flex gap-2 justify-content-end mt-2">
                    ...
                    <a href="{{ route('laporan.aruskas_tidak_langsung') }}" class="btn btn-secondary">Reset</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="text-center mb-4">
        ...
        <h4>Laporan Arus Kas (Metode Tidak Langsung)</h4>
        <p class="text-muted">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    <tbody>
                        ...
                        <tr>
                            <td class="ps-4 fw-bold">Laba Bersih</td>
                            <td class="text-end fw-bold">Rp {{ number_format($labaBersih, 2, ',', '.') }}</td>
                        </tr>
                        
                        <tr class="fw-bold"><td colspan="2" class="ps-4 fst-italic">Penyesuaian untuk merekonsiliasi laba bersih menjadi kas bersih:</td></tr>
                        <tr>
                            <td class="ps-5">Beban Penyusutan</td>
                            <td class="text-end">Rp {{ number_format($bebanPenyusutan, 2, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td class="ps-5">(Kenaikan) Penurunan Piutang</td>
                            <td class="text-end">Rp {{ number_format(-$kenaikanPiutang, 2, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td class="ps-5">(Kenaikan) Penurunan Persediaan</td>
                            <td class="text-end">Rp {{ number_format(-$kenaikanPersediaan, 2, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td class="ps-5">Kenaikan (Penurunan) Utang Usaha</td>
                            <td class="text-end">Rp {{ number_format($kenaikanUtang, 2, ',', '.') }}</td>
                        </tr>
