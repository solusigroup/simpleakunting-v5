...
<style>
        <style>
            ...
            .searchable-select-dropdown { display: none; position: absolute; top: calc(100% + 8px); left: 0; min-width: 320px; background: #fff; border: 1px solid var(--color-border, #dee2e6); border-radius: 12px; box-shadow: 0 15px 50px rgba(0,0,0,0.2); z-index: 9999; max-height: 350px; overflow: hidden; }
            ...
            .searchable-select-option { padding: 10px 16px; cursor: pointer; font-size: 0.875rem; color: var(--color-text, #444); transition: all 0.15s; }
            ...
            /* Essential: Fix clipping in table-responsive */
                    ...
                    <div class="searchable-select" id="ss_${currentRow}">
                        ...
                        <div class="searchable-select-trigger" id="ss_trigger_${currentRow}">
                            <div class="trigger-text placeholder">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="opacity: 0.7;"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                <span>Cari akun...</span>
                            </div>
