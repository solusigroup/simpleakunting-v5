        ...
        <div class="btn-toolbar mb-2 mb-md-0 gap-2">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ route('import-export.export', 'persediaan') }}"><span data-feather="download"></span> Export CSV</a></li>
                    <li><a class="dropdown-item" href="{{ route('import-export.template', 'persediaan') }}"><span data-feather="file"></span> Download Template</a></li>
