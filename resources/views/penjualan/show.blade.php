...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0 gap-2">
            ...
            <a href="{{ route('penjualan.invoice', $penjualan->id_penjualan) }}" target="_blank" class="btn btn-sm btn-primary">
                Cetak Invoice
            </a>
        </div>
        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                ...
                                @if($penjualan->id_project)
                                <tr>
                                    <td><strong>Proyek / Program</strong></td>
                                    <td>: <strong>{{ $penjualan->project->kode_project }}</strong> - {{ $penjualan->project->nama_project }}</td>
                                </tr>
                                @endif
                            </table>
                        </div>
