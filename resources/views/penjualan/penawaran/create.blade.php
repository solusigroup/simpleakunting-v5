...
@section('title', 'Buat Penawaran Penjualan - Simple Akunting')

@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Buat Penawaran Penjualan (Quotation)</h1>
    ...
    <form action="{{ route('penawaran.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="no_penawaran" value="{{ $noPenawaran }}" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Tanggal</label>
                                <input type="date" class="form-control" name="tanggal_penawaran" value="{{ date('Y-m-d') }}" required>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="keterangan" rows="2" placeholder="Catatan internal atau syarat pembayaran..."></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card bg-light mb-3">
                    <div class="card-body text-center d-flex flex-column justify-content-center" style="min-height: 200px;">
                        ...
                        <h1 class="display-5 fw-bold text-primary" id="display_total">Rp 0</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-4 mb-5">
            <button type="submit" class="btn btn-lg btn-primary w-100">SIMPAN PENAWARAN</button>
        </div>
    </form>
@endsection
