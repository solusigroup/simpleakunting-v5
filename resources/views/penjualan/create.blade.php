                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="id_project" name="id_project">
                                ...
                                @foreach($projects as $proj)
                                    <option value="{{ $proj->id_project }}" data-unit="{{ $proj->id_unit_usaha }}" {{ (isset($penawaran) && $penawaran->id_project == $proj->id_project) || old('id_project') == $proj->id_project ? 'selected' : '' }}>{{ $proj->kode_project }} - {{ $proj->nama_project }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
