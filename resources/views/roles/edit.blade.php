...
@section('title', 'Ubah Role - Simple Akunting')

@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Ubah Role: {{ $role->display_name }}</h1>
    ...
    @if($role->is_system)
        <div class="alert alert-info">
            ...
            Ini adalah <strong>Role Sistem</strong>. Beberapa identitas role ini tidak dapat diubah untuk menjaga integritas sistem.
        </div>
    @endif
            ...
            <div class="col-md-5">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label d-block text-muted">ID Role (Slug)</label>
                                                ...
                                                <td class="text-center">
                                                    @if(isset($modulePerms[$action]))
                                                        <input class="form-check-input perm-check" type="checkbox" name="permissions[]" value="{{ $modulePerms[$action]->id }}"
                                                            {{ in_array($modulePerms[$action]->id, $rolePermissions) ? 'checked' : '' }}>
                                                    @else
                                                        -
                                                    @endif
                                                </td>
