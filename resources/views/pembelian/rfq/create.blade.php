...
@section('title', 'Buat RFQ Pembelian - Simple Akunting')

@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Buat Request for Quotation (RFQ)</h1>
    ...
    <form action="{{ route('rfq.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="no_rfq" value="{{ $noRfq }}" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Tanggal</label>
                                <input type="date" class="form-control" name="tanggal_rfq" value="{{ date('Y-m-d') }}" required>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="keterangan" rows="2" placeholder="Catatan internal atau permintaan khusus..."></textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-4 mb-5">
            <button type="submit" class="btn btn-lg btn-primary w-100">SIMPAN RFQ</button>
        </div>
    </form>
@endsection
    ...
    function tambahBaris() {
        ...
        const html = `
            <tr id="row_${idx}">
                ...
                <td>
                    <input type="number" class="form-control form-control-sm" name="details[${idx}][harga_beli]" id="harga_${idx}" onkeyup="hitungSubtotal(${idx})" onchange="hitungSubtotal(${idx})" required>
                </td>
                <td>
