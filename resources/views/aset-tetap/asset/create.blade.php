...
@section('title', 'Tambah Aset Tetap - Simple Akunting')

@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Tambah Data Aset Tetap</h1>
                    ...
                    <form action="{{ route('aset-tetap.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('kode_aset') is-invalid @enderror" id="kode_aset" name="kode_aset" value="{{ old('kode_aset', $kodeAset) }}" required readonly>
                                @error('kode_aset')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('kelompok_aset_id') is-invalid @enderror" id="kelompok_aset_id" name="kelompok_aset_id" required>
                                    ...
                                    @foreach($groups as $g)
                                        <option value="{{ $g->id }}" data-umur="{{ $g->umur_ekonomis }}" {{ old('kelompok_aset_id') == $g->id ? 'selected' : '' }}>
                                            {{ $g->nama_kelompok }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('tanggal_perolehan') is-invalid @enderror" id="tanggal_perolehan" name="tanggal_perolehan" value="{{ old('tanggal_perolehan', date('Y-m-d')) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('harga_perolehan') is-invalid @enderror" id="harga_perolehan" name="harga_perolehan" value="{{ old('harga_perolehan', 0) }}" required min="0">
                                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" class="form-control @error('nilai_residu') is-invalid @enderror" id="nilai_residu" name="nilai_residu" value="{{ old('nilai_residu', 0) }}" required min="0">
                                </div>
                                @error('nilai_residu')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">Nilai sisa aset.</div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="umur_ekonomis_bulan" class="form-label">Umur Ekonomis (Bulan)</label>
                                <input type="number" class="form-control @error('umur_ekonomis_bulan') is-invalid @enderror" id="umur_ekonomis_bulan" name="umur_ekonomis_bulan" value="{{ old('umur_ekonomis_bulan') }}" required min="1">
                        ...
                        <button type="submit" class="btn btn-primary mt-3">Simpan Aset</button>
                    </form>
                </div>
            </div>
        </div>
